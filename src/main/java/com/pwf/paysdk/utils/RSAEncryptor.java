...
public class RSAEncryptor {
	...
	public static String getPrivateKey(String certPath) {
        try {
        	String content = new String(Files.toByteArray(new File(certPath)), StandardCharsets.UTF_8);
    ...
    public String doEncrypt(String plainText, String charset, String publicKey) throws Exception {
